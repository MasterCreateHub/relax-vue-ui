      ...
      items: [
        ...
        },
        {
          ...
          props: {
            ...
            options:
              "{{ $extraContexts.productTypeOptions.filter(item => item.productCategory === $currentValues.productCategory) }}",
          },
        },
        {
          label: "产品名称",
          ...
          props: {
            ...
            options:
              "{{ $extraContexts.productNameOptions.filter(item => item.productType === $currentValues.productType) }}",
          },
          change: [
            {
              target: "price",
